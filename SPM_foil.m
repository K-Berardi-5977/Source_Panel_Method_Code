...
R = 1; %cylinder radius
numB = 9; %number of boundary points (number of panels + 1)
alphad = 0;
alpha = alphad*(pi/180);

[XB, YB, XC, YC, S, betaR, phiR, phiD, theta] = loadCylinder(R, numB, alphad);
% [XB, YB, XC, YC, S, betaR, phiR, phiD, theta] = loadCylinderLastPanel(R, numB, alphad);
